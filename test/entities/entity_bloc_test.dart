...
void main() {
  ...
  group('BlocCore', () {
    ...
    test(
      ...
      expect(() => blocCore.getBloc<int>('test'),
          throwsA(isInstanceOf<UnimplementedError>()));
    });
    ...
    test(
      ...
      expect(() => blocCore.getBlocModule<BlocModule>('test'),
          throwsA(isInstanceOf<UnimplementedError>()));
    });
